...
struct NodoArbol * crearNuevoNodoArbol(struct NodoArbol *, struct Datos, 
                                                          struct NodoArbol *);
void plantarArbolBinario(struct ArbolBinario &, struct NodoArbol *, struct Datos,
                                                       struct NodoArbol * );
void plantarArbolBinario(struct ArbolBinario &, struct ArbolBinario &, struct Datos,
                                                struct ArbolBinario &);
 Datos raiz(struct NodoArbol * nodo);
